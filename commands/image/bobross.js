...
class BobRossCommand extends Command {
    ...
    async exec(message, args) {
        ...
        async function getImages(image) {
            ...
            const canvas = createCanvas(1359, 900);
            ...
            ctx.drawImage(background, 710, 40, 665, 785);
            const { body: buffer } = await superagent.get('https://cdn.discordapp.com/attachments/734432426457301043/834477481469542481/Bob_Ross_painting.png');
